...
{
    struct loc_numanodes_t *g = &memkind_hi_bw_loc_numanodes_g[NODE_VARIANT_MULTIPLE];
    g->init_err = get_per_cpu_local_nodes_mask(&g->per_cpu_numa_nodes,
...
{
    struct loc_numanodes_t *g = &memkind_hi_bw_loc_numanodes_g[NODE_VARIANT_MULTIPLE];
    pthread_once(&memkind_hi_bw_loc_numanodes_once_g[NODE_VARIANT_MULTIPLE], memkind_hi_bw_loc_numanodes_init);
    ...
    struct memkind *kind, unsigned long *nodemask, unsigned long maxnode)
{
    ...
    pthread_once(&memkind_hi_bw_loc_numanodes_once_g[NODE_VARIANT_SINGLE], memkind_hi_bw_loc_preferred_numanodes_init);
