...
{
    struct hi_cap_loc_numanodes_t *g = &memkind_hi_cap_loc_numanodes_g;
    ...
    struct memkind *kind, unsigned long *nodemask, unsigned long maxnode)
{
    ...
    pthread_once(&memkind_hi_cap_loc_numanodes_once_g,
...
static void memkind_hi_cap_find(struct hi_cap_numanodes_t *g, memkind_node_variant_t node_variant)
{
    long long best = 0;
