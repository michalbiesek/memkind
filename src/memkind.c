...
static struct memkind MEMKIND_BALANCED_LOCAL_STATIC = {
    .ops = &MEMKIND_BALANCED_LOCAL_OPS,
    .partition = MEMKIND_PARTITION_BALANCED_LOCAL,
    .name = "memkind_balanced_local",
    .init_once = PTHREAD_ONCE_INIT,
};

static struct memkind MEMKIND_DAX_KMEM_BALANCED_STATIC = {
    .ops = &MEMKIND_DAX_KMEM_BALANCED_OPS,
    .partition = MEMKIND_PARTITION_DAX_KMEM_BALANCED,
    .name = "memkind_dax_kmem_balanced",
    .init_once = PTHREAD_ONCE_INIT,
};
...
MEMKIND_EXPORT struct memkind *MEMKIND_BALANCED_LOCAL = &MEMKIND_BALANCED_LOCAL_STATIC;
MEMKIND_EXPORT struct memkind *MEMKIND_DAX_KMEM_BALANCED = &MEMKIND_DAX_KMEM_BALANCED_STATIC;
...
static struct memkind_registry memkind_registry_g = {
    {
        ...
        [MEMKIND_PARTITION_BALANCED_LOCAL] = &MEMKIND_BALANCED_LOCAL_STATIC,
        [MEMKIND_PARTITION_DAX_KMEM_BALANCED] = &MEMKIND_DAX_KMEM_BALANCED_STATIC,
    },
