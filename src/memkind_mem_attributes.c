...
int set_closest_numanode_mem_attr(void **closest_numanode, int num_cpu, memkind_node_variant_t node_variant)
{
    ...
    struct vec_cpu_node *node_arr = (struct vec_cpu_node *) calloc(num_cpu, sizeof(struct vec_cpu_node));
