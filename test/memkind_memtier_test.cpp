...
TEST_F(MemkindMemtierDynamicTest, test_tier_policy_dynamic_threshold_ctl_set_only_val)
{
    int res = memtier_builder_add_tier(m_builder, MEMKIND_DEFAULT, 1);
    ASSERT_EQ(0, res);
    res = memtier_builder_add_tier(m_builder, MEMKIND_REGULAR, 2);
...
TEST_F(MemkindMemtierDynamicTest, test_tier_policy_dynamic_threshold_ctl_set_internals)
{
    int res = memtier_builder_add_tier(m_builder, MEMKIND_DEFAULT, 1);
    ASSERT_EQ(0, res);
    res = memtier_builder_add_tier(m_builder, MEMKIND_REGULAR, 2);
...
TEST_F(MemkindMemtierDynamicTest, test_tier_policy_dynamic_threshold_ctl_set_only_last)
{
    size_t val = 8000;
    int res = memtier_ctl_set(
